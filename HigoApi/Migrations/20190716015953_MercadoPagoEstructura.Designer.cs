...
namespace HigoApi.Migrations
{
    ...
    [Migration("20190716015953_MercadoPagoEstructura")]
    partial class MercadoPagoEstructura
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HigoApi.Models.Control", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaHoraControlFinal")
                        .HasColumnName("Fecha_Hora_Control_Final");

                    b.Property<DateTime?>("FechaHoraControlInicial")
                        .HasColumnName("Fecha_Hora_Control_Inicial")
                        .HasColumnType("datetime");

                    b.Property<int?>("FuncionamientoGeneralFinal")
                        .HasColumnName("Funcionamiento_General_Final");

                    b.Property<int?>("FuncionamientoGeneralInicial")
                        .HasColumnName("Funcionamiento_General_Inicial");

                    b.Property<int?>("HigieneExternaFinal")
                        .HasColumnName("Higiene_Externa_Final");

                    b.Property<int?>("HigieneExternaInicial")
                        .HasColumnName("Higiene_Externa_Inicial");

                    b.Property<int?>("HigieneInternaFinal")
                        .HasColumnName("Higiene_Interna_Final");

                    b.Property<int?>("HigieneInternaInicial")
                        .HasColumnName("Higiene_Interna_Inicial");

                    b.Property<int?>("IdOperacion")
                        .HasColumnName("Id_Operacion");

                    b.Property<int?>("NivelCombustibleFinal")
                        .HasColumnName("Nivel_Combustible_Final");

                    b.Property<int?>("NivelCombustibleInicial")
                        .HasColumnName("Nivel_Combustible_Inicial");
            ...
            modelBuilder.Entity("HigoApi.Models.OperacionMp", b =>
                {
                    b.Property<int>("IdOperacionMp")
                    ...
                    b.Property<int>("IdOperacionHigo")
                        .HasColumnName("Id_Operacion_HIGO");

                    b.Property<string>("InitPoint")
                        .HasColumnName("init_point");
                    ...
                    b.HasKey("IdOperacionMp");

                    b.HasIndex("IdOperacionHigo");

                    b.ToTable("Operacion_MP");
                });

            modelBuilder.Entity("HigoApi.Models.OperacionWorkflow", b =>
                {
                    b.Property<int>("IdOperacionWorkflow")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id_Operacion_Workflow")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int>("IdProximoEstado")
                        .HasColumnName("Id_Proximo_Estado");

                    b.Property<string>("Rol")
                        .HasMaxLength(15);

                    b.HasKey("IdOperacionWorkflow");

                    b.HasIndex("IdEstadoActual");

                    b.HasIndex("IdProximoEstado");

                    b.ToTable("Operacion_Workflow");
                });
            ...
            modelBuilder.Entity("HigoApi.Models.Usuario", b =>
                {
                    ...
                    b.Property<string>("EmailMp")
                        .HasColumnName("EmailMP");
                    ...
                    b.Property<string>("TokenMp")
                        .HasColumnName("TokenMP");
            ...
            modelBuilder.Entity("HigoApi.Models.OperacionMp", b =>
                {
                    b.HasOne("HigoApi.Models.Operacion", "IdOperacionHigoNavigation")
                        .WithMany("OperacionMp")
                        .HasForeignKey("IdOperacionHigo")
                        .HasConstraintName("FK_Operacion_MP_Operacion");
                });

            modelBuilder.Entity("HigoApi.Models.OperacionWorkflow", b =>
                {
                    b.HasOne("HigoApi.Models.EstadoOperacion", "IdEstadoActualNavigation")
                        .WithMany("OperacionWorkflowIdEstadoActualNavigation")
                        .HasForeignKey("IdEstadoActual")
                        .HasConstraintName("FK_Workflow_Operacion_Estado_Actual");

                    b.HasOne("HigoApi.Models.EstadoOperacion", "IdProximoEstadoNavigation")
                        .WithMany("OperacionWorkflowIdProximoEstadoNavigation")
                        .HasForeignKey("IdProximoEstado")
